...
\end{equation}
where $64$ is the total number of entries, and $\sum_{i} (\mu_{l})_{i}$ is the sum of all entries of the prototype. In this way, we are able to give a coefficient, representing importance, to each feature based on its label.
